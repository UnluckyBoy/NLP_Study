...
if __name__ == '__main__':
    ...
    parser.add_argument('--caption_path', type=str,default='data/annotations/train.json',help='注释文件地址')
    parser.add_argument('--vocab_path', type=str, default='./data/vocab.pkl',help='词汇表文件地址')
    parser.add_argument('--threshold', type=int, default=1,help='词汇阈值')
